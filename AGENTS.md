...
- Current owner override: defer automated movement/flicker testing; owner will report those issues. Prioritize fixed-pose numerical image comparisons, with occasional visual inspection at meaningful checkpoints.
