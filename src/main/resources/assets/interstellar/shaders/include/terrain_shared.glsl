...
#ifdef INTERSTELLAR_TRIANGLE_ROW
// Each nine-texel terrain triangle stays in one 4095-wide row. Share the
// base quotient/remainder across its attribute fetches. Moving rows can split triangles.
