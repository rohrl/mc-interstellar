    ...
    public void onInitializeClient() {
        ...
        CoreShaderRegistrationCallback.EVENT.register(context -> {
            if(org.lwjgl.opengl.GL.getCapabilities().GL_ARB_shader_bit_encoding) {
                ...
                context.register(Identifier.of("interstellar", "terrain_mesh_long"), VertexFormats.POSITION, TerrainScreen::setLongMeshShader);
                context.register(Identifier.of("interstellar", "terrain_live_long"), VertexFormats.POSITION, TerrainScreen::setLongDefaultShader);
                ...
                context.register(Identifier.of("interstellar", "terrain_live_materials"), VertexFormats.POSITION, TerrainScreen::setMaterialShader);
                context.register(Identifier.of("interstellar", "terrain_live_material_probe"), VertexFormats.POSITION, TerrainScreen::setMaterialProbeShader);
                context.register(Identifier.of("interstellar", "terrain_live_material_mask"), VertexFormats.POSITION, TerrainScreen::setMaterialMaskedShader);
                ...
                context.register(Identifier.of("interstellar", "terrain_quad_probe"), VertexFormats.POSITION, TerrainScreen::setQuadProbeShader);
                ...
                context.register(Identifier.of("interstellar", "terrain_cloud_probe"), VertexFormats.POSITION, program->TerrainScreen.setCloudShader(0,program));
                context.register(Identifier.of("interstellar", "terrain_cloud_mask"), VertexFormats.POSITION, program->TerrainScreen.setCloudShader(1,program));
                context.register(Identifier.of("interstellar", "terrain_cloud_materials"), VertexFormats.POSITION, program->TerrainScreen.setCloudShader(2,program));
                context.register(Identifier.of("interstellar", "terrain_cloud_diagnostic"), VertexFormats.POSITION, program->TerrainScreen.setCloudShader(3,program));
                ...
                if(TerrainProfile.ENABLED)for(int pass=0;pass<3;pass++) {
                    ...
                    context.register(Identifier.of("interstellar", "terrain_cloud_profile_"+p),VertexFormats.POSITION,program->TerrainProfile.cloudPrograms[p]=program);
                }
