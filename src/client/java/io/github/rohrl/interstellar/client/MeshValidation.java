...
final class MeshValidation {
    ...
    static String run(ShaderProgram shader,Runnable draw,float angularCap,float curveFactor,boolean quads,boolean splitMoving,boolean cloudQuads) {
        ...
        try(var triangles=new MeshArena(1,false,quads?QuadVertices.WIDTH:MeshArena.WIDTH);var nodes=new MeshArena(2);var compactNodes=new MeshArena(2,true)) {
            ...
            set(shader,"MeshMode",1);set(shader,"MeshCoverage",1);set(shader,"MeshClouds",0);set(shader,"MovingNodeCount",0);set(shader,"CloudNodeCount",0);set(shader,"CloudVertexBase",0);
            ...
            int materials=MaterialValidation.run(shader,draw,triangles,nodes,compactNodes,quads,splitMoving,cloudQuads);
    ...
    private static int[] criticalBoundary(ShaderProgram shader,Runnable draw,java.nio.FloatBuffer pixels,float angularCap,float curveFactor) {
        ...
        set(shader,"MeshNodeCount",0);set(shader,"MovingNodeCount",0);set(shader,"CloudNodeCount",0);set(shader,"CloudVertexBase",0);
