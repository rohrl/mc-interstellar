...
final class AppearanceCapture {
    ...
    static void finish(TerrainScreen screen) {
        ...
        try {
            ...
            if(comparison==8) {
                screen.renderFinalShadeComparison(true);reference=readFramebuffer();screen.renderFinalShadeComparison(false);
