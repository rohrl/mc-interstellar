...
final class AppearanceCapture {
    ...
    static void finish(TerrainScreen screen) {
        ...
        try {
            ...
            if(comparison==16) {
                screen.renderCloudComparison(true);reference=readFramebuffer();screen.renderCloudComparison(false);
