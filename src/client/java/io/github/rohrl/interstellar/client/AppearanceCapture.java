...
final class AppearanceCapture {
    ...
    static void finish(TerrainScreen screen) {
        ...
        try {
            ...
            if(comparison==11) {
                screen.renderFacingComparison(true);reference=readFramebuffer();screen.renderFacingComparison(false);
