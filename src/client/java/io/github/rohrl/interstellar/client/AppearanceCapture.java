...
final class AppearanceCapture {
    ...
    static void finish(TerrainScreen screen) {
        ...
        try {
            ...
            if(comparison==8) {
                screen.renderEmptySpanComparison(true);reference=readFramebuffer();screen.renderEmptySpanComparison(false);
