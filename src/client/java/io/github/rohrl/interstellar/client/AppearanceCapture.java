...
final class AppearanceCapture {
    ...
    static void finish(TerrainScreen screen) {
        ...
        try {
            ...
            if(comparison==13) {
                screen.renderRowComparison(true);reference=readFramebuffer();screen.renderRowComparison(false);
