...
final class AppearanceCapture {
    ...
    static void finish(TerrainScreen screen) {
        ...
        try {
            ...
            if(comparison==16) {
                screen.renderActorComparison(true);reference=readFramebuffer();screen.renderActorComparison(false);
