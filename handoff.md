...
LATEST: owner likes the repaired nighttime sky (16e8df3), reports mountain shading and slight size jump at F10 boundary. Replaced artificial source-relative distant fade with native camera-relative terrain fog; see docs/native-fog.md for exact evidence. Just-inside-boundary zero-bending pair has matching effective FOV77 and aligned platform, but mountains still differ. Hard128 limit turns off nonzero lensing and remains an apparent-jump cause; no physics fade introduced. Build/45 tests, runtime capture and automatic boundary pause/recovery pass. Live far-pose GPU p95=9.645760ms, frame p95=11.7428ms with prior exclusions. Current logs native-fog-build.log/native-fog-runtime.log. Client F10 on at far pose below, creative flight, small window. Next: actual terrain lighting/AO/filtering, geometry/coverage and hard viewing boundary; clouds in front of terrain remain omitted. Daylight/settings/dimensions still need coverage. Earlier repair metrics below are historical.
