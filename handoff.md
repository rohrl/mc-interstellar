...
LATEST: native corner lighting/AO captured from BlockModelRenderer, shared in a bounded atlas. F9 O compares smooth versus face lighting (K on); F10 defaults on. Controlled wall/floor RGB MAE 0.0409→0.0333; daylight downward mountains 0.0380→0.0262, with pixel-identical vanilla references in both comparisons. See docs/smooth-lighting.md. Final build/45 tests and runtime pass. Live far-pose GPU p95=9.719936 ms, frame p95=11.8643 ms with prior exclusions. Capture is slower (~3.8 s versus prior ~1.9 s); frame-scoped brightness cache verified after usage-limit interruption. Current logs smooth-light-final-build.log/smooth-light-verified-runtime.log. Final scene 11,697 opaque, zero unknown/unsupported, N64; no agent block edits. Client F10 on at far pose below, creative flight, small window. Next: foreground clouds/depth, geometry/coverage and hard128 viewing boundary; reduce recapture work before expanding coverage. Material/filtering, precipitation and other settings/dimensions remain incomplete. Earlier repair metrics below are historical.
