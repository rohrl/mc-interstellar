...
| 2. Wider useful viewing range | **Core implemented:** native streamed terrain, live mobs/clouds, and camera access up to256 blocks with automatic recovery. Remaining work includes coverage/material limits and independent curved-mesh checks. Ordinary-screen background compositing remains rejected. |
