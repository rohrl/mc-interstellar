...
was changed. Original item4 was subsequently tested in [compressed bounds](quantized-node-bounds.md).

Probe moving-node visits63.77M→63.65M (0.18% fewer), cloud entries unchanged,
actor entries89,401→92,792. The implementation is preserved at `7a168fb`.
