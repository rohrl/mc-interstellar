...
## Live background checkpoint — 2026-09-16, codex/demo-package

Owner-prioritized replacement of F10 missing-data grid with ordinary world background implemented. F9 keeps the diagnostic grid. Build/45 tests pass; near/far live views and F9/F10 transition visually checked; V reports zero mismatches/unresolved rays. Far 1440p/half-resolution GPU p95=5.168704 ms, frame interval p95=9.4794 ms. Distant scenery is unbent; uncaptured foreground occlusion and duplicate/boundary artifacts remain limitations. No world blocks changed. Details: docs/live-background.md, D030. Demo command packaging has not yet been implemented; resume it next.
